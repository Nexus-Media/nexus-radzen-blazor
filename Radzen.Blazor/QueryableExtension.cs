...
namespace Radzen
{
    ...
    public static class QueryableExtension
    {
        ...
        public static string ToFilterString<T>(this IEnumerable<NexusGridColumn<T>> columns)
        {
            Func<NexusGridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
                !(c.FilterValue == null || c.FilterValue as string == string.Empty) && c.GetFilterProperty() != null;
        ...
        /// <param name="columns">The columns.</param>
        /// <returns>System.String.</returns>
        public static string ToFiltefrString<T>(this IEnumerable<RadzenDataGridColumn<T>> columns)
        {
        ...
        public static string ToFiltefrString<T>(this IEnumerable<NexusDataGridColumn<T>> columns)
        {
            Func<NexusDataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
               (!(c.GetFilterValue() == null || c.GetFilterValue() as string == string.Empty) || c.GetFilterOperator() == FilterOperator.IsNotNull
                   || c.GetFilterOperator() == FilterOperator.IsNull || c.GetFilterOperator() == FilterOperator.IsEmpty
                   || c.GetFilterOperator() == FilterOperator.IsNotEmpty)
               && c.GetFilterProperty() != null;
        ...
        private static string GetColumnFilter<T>(NexusGridColumn<T> column, bool second = false)
        {
            var property = PropertyAccess.GetProperty(column.GetFilterProperty());
        ...
        private static string GetColumnFilter<T>(NexusDataGridColumn<T> column, string value, bool second = false)
        {
            var property = PropertyAccess.GetProperty(column.GetFilterProperty());
        ...
        private static string GetColumnODataFilter<T>(NexusGridColumn<T> column, bool second = false)
        {
            var columnType = column.Type;
            var columnFormat = column.Format;
        ...
        internal static string GetColumnODataFilter<T>(NexusDataGridColumn<T> column, object filterValue, FilterOperator columnFilterOperator)
        {
            var property = column.GetFilterProperty().Replace('.', '/');
        ...
        public static string ToODataFilterString<T>(this IEnumerable<NexusGridColumn<T>> columns)
        {
            Func<NexusGridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
                !(c.FilterValue == null || c.FilterValue as string == string.Empty) && c.GetFilterProperty() != null;
        ...
        public static string ToODataFilterString<T>(this IEnumerable<NexusDataGridColumn<T>> columns)
        {
            Func<NexusDataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
               (!(c.GetFilterValue() == null || c.GetFilterValue() as string == string.Empty)
                || c.GetFilterOperator() == FilterOperator.IsNotNull || c.GetFilterOperator() == FilterOperator.IsNull
        ...
        public static IQueryable<T> Where<T>(this IQueryable<T> source, IEnumerable<NexusGridColumn<T>> columns)
        {
            Func<NexusGridColumn<T>, bool> canFilter = (c) => c.Filterable && !string.IsNullOrEmpty(c.Type) &&
                !(c.FilterValue == null || c.FilterValue as string == string.Empty) && c.GetFilterProperty() != null;
        ...
        public static IQueryable<T> Where<T>(this IQueryable<T> source, IEnumerable<NexusDataGridColumn<T>> columns)
        {
            Func<NexusDataGridColumn<T>, bool> canFilter = (c) => c.Filterable && c.FilterPropertyType != null &&
               (!(c.GetFilterValue() == null || c.GetFilterValue() as string == string.Empty)
                || c.GetFilterOperator() == FilterOperator.IsNotNull || c.GetFilterOperator() == FilterOperator.IsNull
