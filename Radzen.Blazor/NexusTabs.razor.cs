...
namespace Radzen.Blazor
{
    ...
    ///     &lt;Tabs&gt;
    ///         &lt;NexusTabsItem Text="Orders"&gt;
    ///             Details for Orders
    ///         &lt;/NexusTabsItem&gt;
    ///         &lt;NexusTabsItem Text="Employees"&gt;
    ...
    /// </code>
    /// </example>
    public partial class NexusTabs : RadzenComponent
    {
        /// <summary>
        ...
        List<NexusTabsItem> tabs = new List<NexusTabsItem>();

        /// <summary>
        /// Adds the tab.
        /// </summary>
        /// <param name="tab">The tab.</param>
        public async Task AddTab(NexusTabsItem tab)
        {
        ...
        public void RemoveItem(NexusTabsItem item)
        {
        ...
        internal bool IsSelected(NexusTabsItem tab)
        {
            return IndexOf(tab) == selectedIndex;
        }

        internal int IndexOf(NexusTabsItem tab)
        {
            return tabs.IndexOf(tab);
        }

        internal async Task SelectTab(NexusTabsItem tab, bool raiseChange = false)
        {
            selectedIndex = IndexOf(tab);
        ...
        internal async System.Threading.Tasks.Task SelectTabOnClient(NexusTabsItem tab)
        {
        ...
        internal NexusTabsItem FirstVisibleTab()
        {
